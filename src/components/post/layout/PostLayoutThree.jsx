		...
		!imported ?
			<div className={`media post-block m-b-xs-30 ${postSizeMd === true ? "post-block__mid" : ""} ${postBgDark === true ? "post-block__on-dark-bg" : ""}`}>
				...
				<div className="media-body">
					...
					{postSizeMd === true ?
						<p className="mid">{data.excerpt.substring(0, 400)}...</p> : ""
					}
			...
			<div className={`media post-block m-b-xs-30 ${postSizeMd === true ? "post-block__mid" : ""} ${postBgDark === true ? "post-block__on-dark-bg" : ""}`}>
				<Link href={data.link} className="align-self-center">
					<Image
						src={data?.enclosure?.url + '?auto=compress&cs=tinysrgb&h=350' || '/images/cropped_image.png'}
						alt={data.title}
						width={postSizeMd === true ? 285 : 150}
						height={postSizeMd === true ? 285 : 150}
						unoptimized
				...
				<div className="media-body">
					...
					<p className="mid">{data.content.substring(0, 100)}...</p>
					<div className="post-metas">
						<ul className="list-inline">
							<li>
