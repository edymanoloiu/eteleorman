...
const TITLE = "Administrație locală";
const PATH = "/administratie-locala/";
const TOPIC = "administratie-locala";

export default function TopicHub({ items }) {
	const description = `Decizii, instituții și servicii administrative în {city}.`.replace("{city}", publication.city);
	return (
		<HubPage
			title={TITLE}
