...
const TITLE = "Utilități";
const PATH = "/utilitati/";
const TOPIC = "utilitati";

export default function TopicHub({ items }) {
	const description = `Utilități și servicii de infrastructură în {city}.`.replace("{city}", publication.city);
	return (
		<HubPage
			title={TITLE}
