...
const TITLE = "Sport local";
const PATH = "/sport-local/";
const TOPIC = "sport-local";

export default function TopicHub({ items }) {
	const description = `Sport și activități sportive în {city}.`.replace("{city}", publication.city);
	return (
		<HubPage
			title={TITLE}
