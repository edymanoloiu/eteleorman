...
const TITLE = "Economie locală";
const PATH = "/economie-locala/";
const TOPIC = "economie-locala";

export default function TopicHub({ items }) {
	const description = `Economie, afaceri și piața muncii în {city}.`.replace("{city}", publication.city);
	return (
		<HubPage
			title={TITLE}
