...
const TITLE = "Siguranță publică";
const PATH = "/siguranta-publica/";
const TOPIC = "siguranta-publica";

export default function TopicHub({ items }) {
	const description = `Siguranță publică și ordine în {city}.`.replace("{city}", publication.city);
	return (
		<HubPage
			title={TITLE}
