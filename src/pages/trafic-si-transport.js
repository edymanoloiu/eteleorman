...
const TITLE = "Trafic și transport";
const PATH = "/trafic-si-transport/";
const TOPIC = "trafic-si-transport";

export default function TopicHub({ items }) {
	const description = `Informații despre trafic, transport public și mobilitate în {city}.`.replace("{city}", publication.city);
	return (
		<HubPage
			title={TITLE}
